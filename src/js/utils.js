...
/**
 * Returns value of unit in fan
 *
 * @method getValueOfUnit
 * @param {String} unit the unit to convert to, default scdo
 * @returns {BigNumber} value of the unit (in Fan)
...
/**
 * Takes a number of fan and converts it to any other scdo unit.
 *
 * @method fromFan
...
/**
 * Takes a number of a unit and converts it to fan.
 *
 * @method toFan
